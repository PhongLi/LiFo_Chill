const Videos = {
    ...
    van: { in: 'van/van.mp4', inRain: 'van/van-rain.mp4', outFire: 'van/van-out-fire.mp4', out: 'van/van-out.mp4' },
    summer: {
    ...
    cottage: {
        in: 'cottage/Cottage+Int+Final.mp4',
    ...
    train: {
        cityDay: 'Train+Set+-+City+Day.mp4',
        cityNight: 'Train+Set+-+City+Night.mp4',
        cityDayRain: 'Train+Set+-+City+Rain.mp4',
        cityNightRain: 'Train+Set+-+City+Rainy+Night.mp4',
        countryDay: 'Train+Set+-+Country+Day.mp4',
        countryNight: 'Train+Set+-+Country+Night.mp4',
        countryRainDay: 'Train+Set+-+Country+Rainy+Day.mp4',
        countryRainNight: 'Train+Set+-+Country+Rainy+Night.mp4',
    },
    newYork: {
        bedRoomDay: 'new-york/New+York+Bedroom+Day.mp4',
        bedRoomNight: 'new-york/New+York+Bedroom+Night.mp4',
        bedRoomDayRain: 'new-york/New+York+Bedroom+Rainy+Day.mp4',
        bedRoomNightRain: 'new-york/New+York+Bedroom+Rainy+Night.mp4',
        ...
        centralParkNightRain: 'new-york/New+York+Bedroom+Rainy+Night.mp4',
    },
    greenHouse: {
        greenHouseDay: 'green-house/LOFI.CO+-+GARDEN+-+DAY.mp4',
        greenHouseNight: 'green-house/GARDEN+-+NIGHT.mp4',
        greenHouseDayRain: 'green-house/LOFI.CO+-+GARDEN+-+DAY+-+RAIN.mp4',
        greenHouseNightRain: 'green-house/LOFI.CO+-+GARDEN+-+NIGHT+-+RAIN.mp4',
    },
    seoul: {
